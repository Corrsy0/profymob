...
✅ **Başarılı**: Ana sayfaya yönlendirileceksiniz ❌ **Başarısız**: Hata mesajını kontrol edin
...
✅ **Yeşil**: Bakiye yeterli (>$5) ⚠️ **Sarı**: Bakiye düşük ($1-$5) ❌ **Kırmızı**: Bakiye yetersiz (<$1)
