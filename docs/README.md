# ProfyMob Kullanım Kılavuzu

## Hoş Geldiniz! 👋

**ProfyMob**, SEO uzmanları ve dijital pazarlamacılar için geliştirilmiş otomatik backlink üretim yazılımıdır. 70+ farklı platformda profil, sosyal işaretleme, blog yazısı ve yorum oluşturarak sitenizin otoritesini artırır.
...
3. Captcha ve Email servisi API anahtarlarınızı tanımlayın
4. İlk projenizi oluşturun
5. Backlink üretimine başlayın!
